function [F1c,F2c] = PerezCoefficients(model)
% [F1c,F2c] = PerezCoefficients(model) - isolated from PV_LIB
% See PVLMOD_PEREZ, PVLMOD_PEREZCOEFFS, PEREZCOEFF_PLOT

    if nargin < 1 || isempty(model), model = '1990'; end
